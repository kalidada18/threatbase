            ...
            >
              ...
              <div className="p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 text-center md:text-left relative z-10">
                <div className="relative">
                  ...
                  <img src={getAvatarForName(leader.reporter_alias)} alt="Avatar" className="w-32 h-32 rounded-full border-4 border-yellow-500/30 object-cover shadow-2xl relative z-10" />
